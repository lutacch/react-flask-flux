...
def login_user():
    ...
    return jsonify({"message": "el usuario se ha logueado con exito", "user": user.serialize(),"token": token}) ,200
...
def handle_private():
    ...
    return jsonify({"message": "el usuario es veridico", "user": user.serialize()}) ,200